...
int main(int argc, char *argv[])
{
	...
	int messageLength = 0;
	char** message1 = "UPDATE CLASSICS set AUTHOR = '*** UNKNOWN ***' where isbn = 9780199535729"; //this client's command1
	char** message2 = "UPDATE CLASSICS set AUTHOR = 'Herman Melville' where isbn = 9780199535729"; //this client's command1
